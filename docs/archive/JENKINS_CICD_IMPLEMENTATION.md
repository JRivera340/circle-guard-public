...
- Registry: Docker Hub (`docker.io`) under the `jrivera340` organization. Image names: `jrivera340/circleguard-<service>`.
...
5. Docker image build for 6 services and push to Docker Hub (`jrivera340/*`)
