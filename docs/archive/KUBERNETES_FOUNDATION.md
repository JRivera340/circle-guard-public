...
- The pipeline in the repository root (`Jenkinsfile`) builds the 6 selected services, produces Docker images under `docker.io/jrivera340/`, and deploys them using Kustomize overlays.
